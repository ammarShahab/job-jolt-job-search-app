    ...
    <div>
      ...
      <section class="bg-gray-200 rounded-2xl mt-10 mb-10 text-gray-800 px-6 py-12 md:px-12 lg:px-24 shadow-2xl">
        <div class="max-w-5xl mx-auto">
          ...
          <p class="text-base md:text-lg leading-relaxed text-center mb-8">
          ...
          <div class="mb-10">
            <h3 class="text-2xl font-semibold mb-2">Who We Serve</h3>
            <p class="text-base md:text-lg leading-relaxed">
          ...
          <div class="mb-10">
            <h3 class="text-2xl font-semibold mb-2">Why Choose JobJolt?</h3>
            <ul class="list-disc pl-6 text-base md:text-lg space-y-2">
          ...
          <div class="text-center mt-12">
            <Link
              to="/"
              class="inline-block bg-blue-600 text-white text-lg font-medium px-6 py-3 rounded-xl shadow-md hover:bg-blue-700 transition"
            >
